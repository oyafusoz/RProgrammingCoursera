setwd("c:/Users/Mervin/Google Drive/RProgrammingCoursera")
...
best = function(state, outcome){
    ...
    #Isolate State and Condition columns from outcome_df (COL 2 is Hospital Name)
    outcome_subset = outcome_df[outcome_df$State == state,c(2,outcome_column)]
    
    #Convert mortality rates (i.e. 2nd column) to numbers and NAs
    ...
    #alphabetize the 'best' hospitals (if there are ties) and select the first one
